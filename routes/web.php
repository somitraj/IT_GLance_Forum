...
//added event calendar
    ...
    Route::any('/messages', ['type' => 'main', 'icon' => 'fa_fa-user', 'as' => 'Messages@admin', 'uses' => 'Web\MessageController@GetMessage']);
    Route::any('/messageview/{id}', ['as' => 'MessagesView@admin', 'uses' => 'Web\MessageController@ViewFullMessage']);
...
Route::group(['role' => '2', 'prefix' => 'mentor', 'middleware' => 'auth.mentor'], function () {
    ...
    Route::any('/messages', ['type' => 'main', 'icon' => 'fa_fa-user', 'as' => 'Messages@mentor', 'uses' => 'Web\MessageController@GetMessage']);
    Route::any('/messageview/{id}', ['as' => 'MessagesView@mentor', 'uses' => 'Web\MessageController@ViewFullMessage']);
...
Route::group(['role' => '4', 'prefix' => 'intern', 'middleware' => 'auth.intern'], function () {
   ...
   /* Route::any('/articles', ['type' => 'main', 'icon' => 'fa_fa-newspaper-o', 'as' => 'Articles@intern', function () {
    ...
    Route::any('/messageview/{id}', ['as' => 'MessagesView@intern', 'uses' => 'Web\MessageController@ViewFullMessage']);
    Route::any('/messagesent', ['as' => 'MessagesSent@intern', 'uses' => 'Web\MessageController@ViewMessageSent']);
...
Route::group(['role' => '3', 'prefix' => 'submentor', 'middleware' => 'auth.submentor'], function () {
    ...
    Route::any('/messageview/{id}', ['as' => 'MessagesView@submentor', 'uses' => 'Web\MessageController@ViewFullMessage']);
